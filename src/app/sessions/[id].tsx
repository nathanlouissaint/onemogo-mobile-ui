...
function getSessionProgress(detail: WorkoutSessionDetail | null) {
  ...
  const touchedExercises = detail.items.filter(
  ...
  const touchedProgressPct =
    totalExercises > 0
      ? Math.min(100, Math.round((touchedExercises / totalExercises) * 100))
      : 0;
...
export default function WorkoutSessionDetailScreen() {
  ...
  const integrityWarnings = useMemo(() => {
    ...
    if (session.ended_at && typeof session.duration_min !== "number") {
      warnings.push("Completed session is missing a saved duration.");
    }

    if (progress.totalExercises === 0) {
      warnings.push("No exercises were loaded into this session.");
    }
  ...
  const onOpenAddSet = useCallback((item: WorkoutSessionDetailItem) => {
    setEditingSetId(null);
          ...
          <>
            ...
            <Card style={{ marginBottom: theme.spacing.md }}>
              ...
              <View style={styles.progressHero}>
                ...
                <View style={styles.progressMetricCard}>
                  <Text style={styles.progressMetricValue}>
                    {progress.touchedExercises}/{progress.totalExercises}
                  </Text>
                  <Text style={styles.progressMetricLabel}>Started</Text>
                </View>
              ...
              <View style={styles.progressBlock}>
                <View style={styles.progressHeaderRow}>
                  <Text style={styles.progressLabel}>Completed exercises</Text>
              ...
              <View style={styles.progressBlock}>
                <View style={styles.progressHeaderRow}>
                  <Text style={styles.progressLabel}>Started exercises</Text>
                  <Text style={styles.progressPct}>
                    {progress.touchedProgressPct}%
                  </Text>
                </View>
                <View style={styles.progressTrack}>
                  <View
                    style={[
                      styles.progressFillStarted,
                      { width: `${progress.touchedProgressPct}%` },
                    ]}
                  />
                </View>
              </View>
                              ...
                              <View
                                style={[
                                  ...
                                  status.tone === "complete"
                                    ? styles.exerciseStatusChipComplete
                              ...
                              >
                                <Text
                                  style={[
                                    ...
                                    status.tone === "complete"
                                      ? styles.exerciseStatusChipTextComplete
                                      : status.tone === "progress"
...
const styles = StyleSheet.create({
  ...
  exerciseStatusChipTextComplete: {
    color: "#34d399",
  },
